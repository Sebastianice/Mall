...
namespace Mall.Services
{
    public class MallUserAddressService
    {
        ...
        public async Task DeleteUserAddress(string token, long id)
        {
            ...
            if (address == null) throw ResultException.FailWithMessage("不存在该地址");
        ...
        public async Task<List<UserAddress>> GetMyAddress(string token)
        {
            ...
            if (userToken is null) throw ResultException.FailWithMessage("该用户不存在");
        ...
        public async Task UpdateUserAddress(string token, UpdateAddressParam req)
        {
            ...
            if (adress is null)
            {
                throw ResultException.FailWithMessage("不存在该地址");
            }
